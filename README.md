...
[ARCHITECTURE.md](ARCHITECTURE.md) has the component hierarchy, the context keys, the coordinate systems and the measurement rule the arrow geometry is built on. Start there.
